  ...
  return (
    <>
            ...
            <div className="row align-items-center g-5">
              <div className="hero-left col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                ...
                <h1 className="mb-0 display-6">
                  Online Hostel Listing Platform at Your{" "}
                ...
                <p className="my-4 lead">
                  Thebrick is a free to use hostel search: we work with more
                  than 200+ agents and provide you with the biggest and best
                  selection of mid-to-long term hostels for rent on the
                  internet, around the university.
                </p>

                <ul
                  style={{ color: "#000" }}
                  className="list-inline position-relative justify-content-center justify-content-lg-start mb-4"
                >
                  <li className="list-inline-item me-2">
                    {" "}
                    <i className="fa fa-check"></i>Search for hostels with ease
                  </li>
                  <li className="list-inline-item me-2">
                    {" "}
                    <i className="fa fa-check"></i>Find genuine hostel agents
                  </li>
                </ul>
                ...
                <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                  <a
                    href="#early-access"
                    className="btn btn-lg btn-primary me-2 mb-4 mb-sm-0"
                  >
                    Get early access
                  </a>
                </div>
              ...
              <div className="col-lg-7 col-xl-6 text-center position-relative">
                ...
                <div className="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-xl-block mb-5 ms-5">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="text-start ms-3">
                      ...
                      <p className="mb-0 small text-white">
                        Your hostel was listed successfully
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    background: "url(assets/images/pattern/01.png)",
                    noRepeat: "center center",
                    backgroundSize: "cover",
                  }}
                >
                  <p className="text-white">Our verified agents</p>
                ...
                <div className="position-relative">
                  <img src="assets/images/element/hero-image.GIF" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row g-4 g-lg-5 align-items-center">
              ...
              <div className="col-xl-5 order-1 text-center text-xl-start">
                ...
                <p>
                  Our mission is to eliminate the stress and hassles of finding
                  hostels in universities across Africa. Thebrick is committed
                  to empowering university hostel agents by leveraging on all
                  major technology platforms across mobile, web and IoT devices.
                  Thebrick revenue model is centered on subscription by agents
                  and also on advertisements.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="pt-5">
        <div className="container" id="early-access">
          <EarlyAccess />
                        ...
                        <ul className="list-inline mb-0 mt-3">
                          ...
                          <li className="list-inline-item">
                            ...
                            <a
                              ...
                              href="https://www.instagram.com/thebrick.ng/"
                            >
